...
def generate_report(candidates: list[dict], threshold_days: int, output_path: str) -> None:
    ...
    with open(output_path, "w") as f:
        ...
        f.write("**Action required:** Review each candidate. Approve deletions with Jamey before any bulk action.\n\n")
        f.write("---\n\n")
...
def main():
    ...
    print(f"\nNext step: Review the report. Approve deletions with Jamey before any bulk action.")
