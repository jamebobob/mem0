...
to confirm the sections Eve needs are actually in the system prompt
...
### What this means for Eve's sections
...
## Recommended Test on Walle (Day 2 Morning)

1. Enable LCM on main agent
2. Chat until compaction triggers
3. Ask Eve: "What are your Safety rules?" and "What are your Memory Rules?"
